...
if (content.includes(oldPrompt)) {
    ...
    console.log('✅ Successfully replaced with Japanese teacher prompt!');
} else {
    console.log('❌ Old prompt not found. Searching for partial match...');
    
    // Try searching for a unique part
    if (content.includes('Сургалтын багшийн дүрэм')) {
        console.log('✅ Found Mongolian text, file encoding is correct');
    } else {
        console.log('❌ Cannot find Mongolian text, possible encoding issue');
    }
}
